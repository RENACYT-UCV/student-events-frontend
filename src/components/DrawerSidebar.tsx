...
export default function DrawerSidebar({ open, onClose }: Props) {
  ...
  return (
    <>
      ...
      {/* Drawer lateral con animación de slide */}
      <div
      ...
      >
        <div className="p-4 border-b">
          <h2 className="text-red-600 text-xl font-bold">UniEventos</h2>
        </div>
        ...
        <div className="absolute bottom-0 w-full p-4 border-t text-red-600">
          <NavItem icon={<ArrowRightOnRectangleIcon className="w-5 h-5" />} to="/logout" onClick={onClose}>Cerrar sesión</NavItem>
        </div>
      </div>
    </>
  )
